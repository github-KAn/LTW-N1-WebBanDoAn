...
//    const savedCart = JSON.parse(localStorage.getItem('cartItems')); // Lấy dữ liệu giỏ hàng đã lưu
//    if (savedCart) { // Nếu có dữ liệu, khôi phục giỏ hàng
//        cartItems = savedCart;
//        totalPrice = cartItems.reduce((total, item) => total + item.price, 0); // Tính lại tổng giá trị
